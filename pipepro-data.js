...
// Bolt counts per joint [#150,#300,#600,#900,#1500,#2500]  ASME B16.5 Table
const FL_BOLTS={
  ...
  '4"':   [8,8,8,8,8,8],
  '6"':   [8,12,12,12,12,null],'8"':   [8,12,12,12,12,null],
  '10"':  [12,16,16,16,16,null],'12"':  [12,16,20,20,20,null],
  '14"':  [12,20,20,20,null,null],'16"':  [16,20,20,20,null,null],
  '18"':  [16,24,24,24,null,null],'20"':  [20,24,24,24,null,null],
  '24"':  [20,24,24,24,null,null],
};

// Stud bolt diameter per class [#150,#300,#600,#900,#1500,#2500]
const FL_STUD_DIA={
  '1/2"': ['1/2"','1/2"','1/2"','3/4"','3/4"','3/4"'],
  '3/4"': ['1/2"','5/8"','5/8"','3/4"','3/4"','1"'],
  '1"':   ['1/2"','5/8"','5/8"','7/8"','7/8"','1"'],
  '1-1/4"':['1/2"','5/8"','3/4"','7/8"','1"','1-1/8"'],
  '1-1/2"':['1/2"','3/4"','3/4"','1"','1"','1-1/4"'],
  '2"':   ['5/8"','5/8"','3/4"','1"','1-1/8"','1-1/2"'],
  '2-1/2"':['5/8"','3/4"','7/8"','1-1/8"','1-1/4"','1-3/4"'],
  '3"':   ['5/8"','3/4"','7/8"','1-1/8"','1-1/4"','2"'],
  '4"':   ['5/8"','3/4"','7/8"','1-1/4"','1-1/2"','2-1/2"'],
  '6"':   ['3/4"','7/8"','1"','1-3/8"','1-1/2"',null],
  '8"':   ['3/4"','7/8"','1-1/8"','1-3/8"','2"',null],
  '10"':  ['7/8"','1"','1-1/4"','1-5/8"','2"',null],
  '12"':  ['7/8"','1-1/8"','1-3/8"','1-7/8"','2-1/2"',null],
  '14"':  ['1"','1-1/8"','1-3/8"','2"',null,null],
  '16"':  ['1"','1-1/4"','1-1/2"','2-1/4"',null,null],
  '18"':  ['1-1/8"','1-1/4"','1-5/8"','2-1/2"',null,null],
  '20"':  ['1-1/8"','1-1/4"','1-5/8"',null,null,null],
  '24"':  ['1-1/4"','1-1/2"','1-7/8"',null,null,null],
};
